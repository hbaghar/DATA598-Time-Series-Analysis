...
## Using auto.arima()
This is a function that was written by the authors of the book to iterate through many iterations of ARIMA models and pick the best fit. Although this tool is helpful, we should always inspect the results because sometimes the model may add extra parameters for tiny improvements.
